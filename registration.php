...
if(isset($_POST['s'])){    
       ...
       // $password=md5($u_pass);
       $query = mysqli_query($conn, "insert into user values('$u_name','$u_id','$u_pass','$u_addr','$a_no','$gen','$mob')");
       if ($query) {
        echo "<script>alert('Successfully Registered. You can login now');</script>";
  
      } 
      /*
        $reg="insert into user(name,email,password,adress,aadhar_number,gender,mobile_number) values('$u_name','$u_id','$u_pass','$u_addr','$a_no','$gen','$mob')";
