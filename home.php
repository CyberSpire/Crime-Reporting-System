...
<body>
 ...
 <div class="container">
 	<div class="row">
 		<div class="col-lg-12">
 			<div class="content">
       <center><h1 style="color:red;background-color:grey;width:70%">Have a Complaint?</style></h1></center>
 			  <center><h3 style="color:red;background-color:grey;padding:2%;width:50%">Register Below &nbsp &nbsp<i class="fa fa-hand-o-down" aria-hidden="true"></i></style></h3></center>
 				<hr>
